 ...
 */
function shopsix_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter shopsix default saturation level.
	 *
	 * @since shopsix 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation         = absint( apply_filters( 'shopsix_custom_colors_saturation', 50 ) );
	$reduced_saturation = ( .8 * $saturation ) . '%';
	$saturation         = $saturation . '%';
	$css                = '
/**
 * shopsix: Color Patterns
 *
...
.colors-custom.page:not(.shopsix-front-page) .entry-title,
...
.colors-custom .shopsix-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.shopsix-front-page .panel-content .recent-posts article,
...
.colors-custom.shopsix-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters shopsix custom colors CSS.
	 *
	 * @since shopsix 1.0
	 *
	 ...
	 */
	return apply_filters( 'shopsix_custom_colors_css', $css, $hue, $saturation );
}
